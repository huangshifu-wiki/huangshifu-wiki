...
const mockGalleries: GalleryItem[] = [
  {
    ...
    images: [{ id: 'img-1', assetId: null, url: '/uploads/test-1.jpg', name: 'test-1.jpg', mimeType: 'image/jpeg', sizeBytes: 1024 }],
  ...
  },
  {
    ...
    published: false,
    publishedAt: null,
    images: [{ id: 'img-2', assetId: null, url: '/uploads/test-2.jpg', name: 'test-2.jpg', mimeType: 'image/jpeg', sizeBytes: 1024 }],
